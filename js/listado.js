...
Listado.prototype.buscarRestaurante = function(id) {
	const filtrado = this.restaurantes.find((restaurant) => restaurant.id === id);
	return filtrado || 'No se ha encontrado ningún restaurant';
};

//Obtiene todas las ciudades de los restaurantes sin repetidos
Listado.prototype.obtenerUbicaciones = function() {
	const ciudadesArray = this.restaurantes.map((ciudades) => ciudades.ubicacion);
	return funcionFiltrado(ciudadesArray);
};
...
Listado.prototype.obtenerRubros = function() {
	const rubros = this.restaurantes.map((valores) => valores.rubro);
	return funcionFiltrado(rubros);
};
...
Listado.prototype.obtenerHorarios = function() {
	...
	const horariosArray = this.restaurantes.map((restauranteMap) => restauranteMap.horarios);
	//En este arreglo vamos a poner todos los horarios, uno por uno
	horariosArray.forEach(function(a) {
		a.forEach(function(hor) {
			horariosFiltrados.push(hor);
		});
	});
	//En este arreglo vamos a poner todos los horarios pero sin repetidos
	return funcionFiltrado(horariosFiltrados);
};
...
var listadoDeRestaurantes = [
	new Restaurant(1, 'TAO Uptown', 'Asiática', 'Nueva York', [ '13:00', '15:30', '18:00' ], '../img/asiatica1.jpg', [
		6,
		7,
		9,
		10,
	...
	new Restaurant(5, 'Jolly', 'Asiática', 'Berlín', [ '12:00', '13:30', '16:00' ], '../img/asiatica3.jpg', [
		8,
		3,
		9,
		5,
	...
	new Restaurant(6, 'Green salad', 'Ensalada', 'Berlín', [ '17:00', '19:00', '20:30' ], '../img/ensalada2.jpg', [
		8,
		3,
		2,
		1,
	...
	new Restaurant(7, 'Osteria Da Fortunata', 'Pasta', 'Roma', [ '13:00', '15:30', '18:00' ], '../img/pasta2.jpg', [
		7,
		7,
		7,
		7,
	...
	new Restaurant(8, 'Cafe Francoeur', 'Desayuno', 'París', [ '14:30', '15:30', '19:00' ], '../img/desayuno1.jpg', [
		4,
		7,
		9,
		8,
	...
	new Restaurant(9, 'La Trottinette', 'Pasta', 'París', [ '16:00', '18:00', '21:30' ], '../img/pasta5.jpg', [
		8,
		8,
		7,
		7,
	...
	new Restaurant(12, 'Just Salad', 'Ensalada', 'Nueva York', [ '12:00', '15:00', '17:30' ], '../img/ensalada3.jpg', [
		8,
		1,
		4,
		5,
	...
	new Restaurant(15, "Carmine's", 'Pasta', 'Nueva York', [ '14:30', '16:30', '19:00' ], '../img/pasta1.jpg', [
		9,
		8,
		5,
		5,
	...
	new Restaurant(16, 'Pastasciutta', 'Pasta', 'Roma', [ '14:30', '15:30', '19:00' ], '../img/pasta3.jpg', [
		4,
		9,
		10,
		9,
	...
	new Restaurant(17, 'Vapiano', 'Pasta', 'Berlín', [ '12:00', '15:00', '17:30' ], '../img/pasta4.jpg', [
		8,
		4,
		6,
		7,
	...
	new Restaurant(19, 'Les Deux Magots', 'Desayuno', 'París', [ '17:00', '19:00', '22:30' ], '../img/desayuno4.jpg', [
		8,
		4,
		6,
		6,
	...
	new Restaurant(20, 'Pappelli', 'Pizza', 'París', [ '12:00', '15:00', '17:30' ], '../img/pizza3.jpg', [
		8,
		4,
		6,
		7,
	...
	new Restaurant(21, 'Trattoria La Cenetta', 'Pizza', 'Berlín', [ '12:00', '15:00', '17:30' ], '../img/pizza4.jpg', [
		8,
		4,
		6,
		2,
	...
	new Restaurant(23, 'Chez Moi', 'Ensalada', 'París', [ '11:00', '12:00', '14:30' ], '../img/ensalada1.jpg', [
		8,
		4,
		5,
		5,
...
// const funcionFiltrado = (elem, index, self) => index === self.indexOf(elem);

const funcionFiltrado = function(elementoAfiltrar) {
	let elementoFiltrado = elementoAfiltrar.filter((elem, index, self) => index === self.indexOf(elem));
	return elementoFiltrado.sort();
};
